...
1. Load INDEX section from `${PAI_DIRECTORY}/.claude/learnings/analysis/heuristics.md` (~100-150 tokens)
2. Load INDEX section from `${PAI_DIRECTORY}/.claude/learnings/analysis/anti-patterns.md` (~50-100 tokens)
3. Load INDEX section from `${PAI_DIRECTORY}/.claude/learnings/analysis/checklists.md` (~50-100 tokens)
