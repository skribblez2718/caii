...
1. Load INDEX section from `${PAI_DIRECTORY}/.claude/learnings/generation/heuristics.md`
2. Load INDEX section from `${PAI_DIRECTORY}/.claude/learnings/generation/anti-patterns.md`
3. Load INDEX section from `${PAI_DIRECTORY}/.claude/learnings/generation/checklists.md`
