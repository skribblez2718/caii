...
**BEFORE evaluating semantic triggers, check for skill name keyword matches:**

Does the user's query CONTAIN any of these keywords?

| Keyword | Maps to Skill |
|---------|---------------|
...
| "clarify", "clarification" | orchestrate-clarification |
| "analyze", "analysis" | orchestrate-analysis |
| "synthesize", "synthesis" | orchestrate-synthesis |
| "generate", "generation" | orchestrate-generation |
| "validate", "validation" | orchestrate-validation |
| "memory", "track progress" | orchestrate-memory |

**If ANY keyword match is found:**
1. Set CONFIDENCE: HIGH
2. Route to that skill UNLESS explicitly excluded by NOT_FOR criteria
3. This takes PRIORITY over semantic trigger evaluation
