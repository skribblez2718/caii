...
class BaseStep(ABC):
    ...
    # Note: _step_num can be a float (e.g., 0.5 for Step 0.5)
    _step_num: float | None = None
    _step_name: str | None = None

    @property
    def step_number(self) -> float:
        """The step number (0, 0.5, 1-8) - from class attribute or override."""
