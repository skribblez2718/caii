...
class TestTDDEntryModule:
    ...
    def test_entry_module_exists(self):
        ...
        from orchestration.skills.perform_tdd import entry
    ...
    def test_entry_creates_new_state_when_no_tdd_state_arg(
        ...
        """Entry should create new TDDState when --perform-tdd-state not provided."""
        ...
        from orchestration.skills.perform_tdd import entry as entry_module
        ...
        state_files = list(temp_state_dir.glob("perform-tdd-*.json"))
        assert len(state_files) == 1

    def test_entry_loads_existing_state(self, temp_state_dir, monkeypatch, capsys):
        """Entry should load existing TDDState when --perform-tdd-state provided."""
        from orchestration.skills.perform_tdd import tdd_state as tdd_module
...
class TestTDDAdvanceModule:
    ...
    def test_advance_module_exists(self):
        ...
        from orchestration.skills.perform_tdd import advance
    ...
    def test_advance_transitions_to_next_phase(
        ...
        from orchestration.skills.perform_tdd import advance as advance_module
        from orchestration.skills.perform_tdd.tdd_state import TDDPhase, TDDState
...
class TestTDDCompleteModule:
    ...
    def test_complete_module_exists(self):
        ...
        from orchestration.skills.perform_tdd import complete
    ...
    def test_complete_marks_session_completed(
        ...
        from orchestration.skills.perform_tdd import complete as complete_module
        from orchestration.skills.perform_tdd.tdd_state import TDDPhase, TDDState
        ...
        with patch.object(
            sys, "argv", ["complete.py", "--perform-tdd-state", state.session_id]
        ):
