...
│  │   └→ skill_complete()        │                                          │
│  │       └→ Aggregate outputs   │                                          │
│  │       └→ IDEAL STATE verify  │  ← MANDATORY cognitive verification      │
│  │       └→ Generate summary    │                                          │
│  │       └→ SKILL_COMPLETE      │                                          │
│  └──────────────────────────────┘                                          │
└─────────────────────────────────────────────────────────────────────────────┘
...
├── ideal_state_verifier.py # IDEAL STATE verification directives (post-execution)
...
| `ideal_state_verifier.py` | `build_verification_directive()` | Build IDEAL STATE verification directive |
| `ideal_state_verifier.py` | `has_ideal_state()` | Check if reasoning state has IDEAL STATE |
...
8. IDEAL STATE verification MUST complete before skill marked done
